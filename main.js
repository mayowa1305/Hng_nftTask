...
// cli welcome title
const cliTitle = "HNG_NFT_CLI"

// custom function
const sleep = (sec = 1) => new Promise((res) => setTimeout(res, sec * 1000))
const log = (...params) => console.log(...params, "\n")

const printGradientTitle = (text) => log(gradient.atlas.multiline(figlet.textSync(text, { font: "avatar" })))


const printGrdient = (text) => gradient.mind.multiline(text)

const helpText = `
welcome to ${printGrdient("HNG_NFT_CLI ")}.
